...
public abstract class VideoPlayerController extends FrameLayout implements View.OnTouchListener {
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        if (mVideoPlayer.isIdle() || mVideoPlayer.isError() || mVideoPlayer.isPreparing() || mVideoPlayer.isPrepared() || mVideoPlayer.isCompleted()) {
            hideChangePosition();
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mNeedChangeBrightness) {
                    ...
                    WindowManager.LayoutParams params = VideoUtil.scanForActivity(mContext).getWindow().getAttributes();
