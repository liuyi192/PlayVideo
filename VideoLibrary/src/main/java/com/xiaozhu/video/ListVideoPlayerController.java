 ...
 * @备注
 */
public class ListVideoPlayerController extends VideoPlayerController implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, ChangeClarityDialog.OnClarityChangedListener {
    ...
    public ImageView getmFullScreen() {
        return mFullScreen;
    }
    ...
    public void onClick(View v) {
        if (v == mCenterStart) {
            ...
            if (mVideoPlayer.isPlaying() || mVideoPlayer.isPaused() || mVideoPlayer.isBufferingPlaying() || mVideoPlayer.isBufferingPaused()) {
