 ...
 * @备注
 */
public class VideoPlayer extends FrameLayout implements VideoPlayerInterface, TextureView.SurfaceTextureListener {
    /**
     * 播放错误
     **/
    ...
    public void setPlayVideoCallbackListener(PlayVideoCallbackListener playVideoCallbackListener) {
        this.playVideoCallbackListener = playVideoCallbackListener;
    }
    ...
    private IMediaPlayer.OnCompletionListener mOnCompletionListener = new IMediaPlayer.OnCompletionListener() {
        ...
        public void onCompletion(IMediaPlayer mp) {
            ...
            //播放数据清空
            VideoUtil.savePlayPosition(mContext, mUrl, 0);
            if (playVideoCallbackListener != null) playVideoCallbackListener.onPlayCompletion();
        }
    };
    ...
    public void enterFullScreen() {
        ...
        VideoUtil.scanForActivity(mContext).setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
    ...
    public boolean exitFullScreen() {
        if (mCurrentMode == MODE_FULL_SCREEN) {
            ...
            VideoUtil.scanForActivity(mContext).setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
            ViewGroup contentView = (ViewGroup) VideoUtil.scanForActivity(mContext).findViewById(android.R.id.content);
            contentView.removeView(mContainer);
            LayoutParams params = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
            this.addView(mContainer, params);
    ...
    public void enterTinyWindow() {
        ...
        LayoutParams params = new LayoutParams((int) (VideoUtil.getScreenWidth(mContext) * 0.6f), (int) (VideoUtil.getScreenWidth(mContext) * 0.6f * 9f / 16f));
