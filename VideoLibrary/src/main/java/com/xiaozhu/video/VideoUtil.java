...
public class VideoUtil {
    ...
    public static void savePlayPosition(Context context, String url, long position) {
        context.getSharedPreferences("PLAY_POSITION", Context.MODE_PRIVATE).edit().putLong(url, position).apply();
    }
    ...
    public static long getSavedPlayPosition(Context context, String url) {
        return context.getSharedPreferences("PLAY_POSITION", Context.MODE_PRIVATE).getLong(url, 0);
    }
}
